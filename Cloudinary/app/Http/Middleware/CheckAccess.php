...
namespace Plugins\Cloudinary\Http\Middleware;
...
class CheckAccess
{
    public function handle(Request $request, Closure $next)
    {
        ...
        Cookie::queue('fresns_plugin_cloudinary_auth_ulid', $authUlid);
        Cookie::queue('fresns_plugin_cloudinary_auth_uid', $fresnsResp->getData('uid'));
        Cookie::queue('fresns_plugin_cloudinary_file_usage_type', $uploadInfoArr['usageType']);
        Cookie::queue('fresns_plugin_cloudinary_file_usage_fsid', $uploadInfoArr['usageFsid']);
        Cookie::queue('fresns_plugin_cloudinary_file_type', $uploadInfoArr['fileType']);
