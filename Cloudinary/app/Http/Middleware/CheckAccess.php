...
class CheckAccess
{
    public function handle(Request $request, Closure $next)
    {
        ...
        Cookie::queue('fresns_plugin_cloudinary_file_usage_type', $uploadInfoArr[0]);
        Cookie::queue('fresns_plugin_cloudinary_file_usage_fsid', $uploadInfoArr[1]);
        Cookie::queue('fresns_plugin_cloudinary_file_type', $uploadInfoArr[2]);
